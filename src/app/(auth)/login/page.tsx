...
import { Mail, Lock, Eye, EyeOff, ArrowRight, User, Dumbbell } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#0A0A0A] flex flex-col relative overflow-x-hidden">
      ...
      <div className="relative flex-1 flex flex-col items-center justify-center px-5 py-12 min-h-screen">
        ...
        <div className="mb-8 text-center animate-fade-in">
          ...
          <p className="text-white/40 text-sm mt-1.5 font-medium">Track Every Rep. Beat Every Workout.</p>
        </div>
        ...
        <div className="w-full max-w-sm animate-slide-up">
          <div className="bg-[#111111] border border-white/[0.08] rounded-3xl p-7 shadow-[0_24px_80px_rgba(0,0,0,0.6)]">
            ...
            <p className="text-white/40 text-sm mb-7">Sign in to continue your journey</p>

            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
              {/* Identifier */}
              <div className="flex flex-col gap-1.5">
                <label className="text-xs text-white/50 font-semibold uppercase tracking-wider">Email or Mobile</label>
              ...
              >
                {loading ? (
                  <div className="w-4.5 h-4.5 border-2 border-black/20 border-t-black rounded-full animate-spin" />
                ) : (
            ...
            >
              {googleLoading ? (
                ...
                <>
                  <svg className="w-4.5 h-4.5 flex-none" viewBox="0 0 24 24">
